//Lógica
'use strict'
//El import sirve para importar los métodos de distintas clases
...
//Mi login: username: fpaiz password: 12345678
...
export const login = async(req, res)=>{
    try{
        ...
        let user = await User.findOne({ username }) //username: 'fpaiz'
        ...
        if(user && await checkPassword(password, user.password)){
            ...
            let token = await generateJwt(loggedUser) //Pasa la variable con datos
